...
<?php include 'menu.php'; ?>
    ...
    <div id="text">
        ...
        <ul>
            ...
            <li><a href="facturen.php"><img src="images/facturen.png" onmouseover="this.src=\'images/facturenhover.png\'" onmouseout="this.src=\'images/facturen.png\'" alt="Facturen Beheren"></a></li>
        </ul>
    </div>
