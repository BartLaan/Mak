...
<?php
    ...
    # Doorverwijsknoppen
        echo '
            ...
            <div id="knoppen">
                <ul id="knoppen-lijst">
                    <li><a href="productenoverzicht.php"><img src="images/producten.png" onmouseover="this.src=\'images/productenhover.png\'" onmouseout="this.src=\'images/producten.png\'" alt="Producten Beheren" height="50"></a></li>
