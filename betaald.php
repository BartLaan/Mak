            ...
            <div id="text">
                <?php 
                    ...
                    if (!empty($_SESSION['winkelwagen']) && !empty($_POST['betaald'])){ 
                        ...
                        # factuur toevoegen 
                        $factuur_toevoegen = "INSERT INTO `Mak`.`Factuur` (`Factuur_ID`, `Klant_ID`, `Verzendmethode`, `Factuur_Datum`, `Verzendstatus`, `Betaalstatus`) VALUES (NULL, '".$Klant_ID."', '".$verzendmethode."', '".$datum."', 'Niet verzonden', 'Betaald');";
