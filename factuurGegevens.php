...
if (!isset($_GET['id'])) {
    ...
    if ($result && strlen($result["Emailadres"]) > "0") {
        ...
        $stmt = $db->prepare("SELECT 'Factuur.Factuur_ID', 'Factuur.Factuur_Datum', 'Factuur.Klant_ID', 'Factuur.Verzendmethode', 'Factuur.Totaalprijs', 'Product_Factuur_Doorverwijzing.Aantal', 'Factuur_Product.Productnaam', 'Factuur_Product.Prijs' FROM Product_Factuur_Doorverwijzing LEFT JOIN Factuur ON 'Product_Factuur_Doorverwijzing.Factuur_Product_ID'='Factuur.Factuur_Product_ID' LEFT JOIN 'Factuur_Product' ON 'Product_Factuur_Doorverwijzing.Factuur_Product_ID'='Factuur_Product.Factuur_Product_ID'");
