                            ...
                            <div class="bestellingsInformatie">
                                ...
                                <p>Totaal Incl. BTW: &#8364: '.trimLeadingZeroes($goede_totaal).'</p>';
                                        ...
                                        if (isset($_SESSION['login_success']) && $_SESSION['login_success'] == true) {
                                            echo '<a href="bestellen.php"><img src="images/afrekenen.png" alt="afrekenen" onmouseover="this.src="images/afrekenenhover.png" onmouseout="this.src="images/afrekenen.png"" style="width:171px; height:40px;" ></a>';
                                        } else {
